...
class Utility(commands.Cog):
    ...
    async def about(self, ctx):
        ...
        desc = "This is a Discord bot that servers as a modmail meant for "
        ...
        embed.add_field(name="Authors", value="`save0`")
        ...
        embed.add_field(
            ...
            value="Dm save0#1234 and the service costs 0$!"
            "and dont be scared to ask for support!",
            inline=False,
        )
        ...
        embed.add_field(
            ...
            "like you to support us (donation link coming soon)"
        ...
        embed.add_field(
            ...
            value=f"Checkout the people who supported this project with command `{self.bot.prefix}sponsors`!",
            inline=False,
        )
