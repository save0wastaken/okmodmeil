...
class Version:
    ...
    def __init__(self, bot, branch: str, version: str, lines: str):
        ...
        self.fields = {}
        self.changelog_url = f"https://github.com/save0wastaken/chnglg/blob/{branch}/Changelog.md"
        self.description = ""
        self.parse()
...
class Changelog:
    ...
    async def from_url(cls, bot, url: str = "") -> "Changelog":
        ...
        url = url or f"https://raw.githubusercontent.com/save0wastaken/chnglg/{branch}/Changelog.md"
